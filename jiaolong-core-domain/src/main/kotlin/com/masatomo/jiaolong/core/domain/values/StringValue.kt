...
private fun <V : StringValue> StringValidations.MinimumLength.validate(target: V): ShortLengthString<V>? =
...
private fun <V : StringValue> StringValidations.MaximumLength.validate(target: V): LongLengthString<V>? =
...
private fun <V : StringValue> StringValidations.MatchRegex.validate(target: V): UnmatchRegexString<V>? {
    val (name, regex) = if (type == StringValidations.MatchRegex.InstalledPattern.MANUAL) {
